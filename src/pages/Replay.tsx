  ...
  return (
    <Layout>
      <div className="container mx-auto px-4 py-6">
        <h1 className="font-pixel text-xl neon-text-pink mb-6 flex items-center gap-2">
          <Play size={24} />
          比赛回放
        </h1>
            ...
            {selectedReplay ? (
              <div className="pixel-card">
                ...
                <div className="flex justify-center gap-3">
                  ...
                  <PixelButton variant="primary" onClick={() => navigate('/game')}>
                    再来一局
                  </PixelButton>
                </div>
              ...
              <div className="pixel-card h-[400px] flex flex-col items-center justify-center">
